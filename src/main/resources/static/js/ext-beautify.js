    ...
    exports.beautify = function(session) {
        ...
        while (token !== null) {
            ...
            if (typeof token !== "undefined") {
                ...
                if (!inTag && !rowsToAdd && (token.type === "paren.rparen" || token.type === "rparen") && token.value.substr(0, 1) === "}") {
                    rowsToAdd++;
                }
                if (curRow !== row) {
                    rowsToAdd = curRow;
                ...
                if (value) {
                    ...
                    } else if (token.type === "paren.lparen" || token.type === "lparen") {
                        trimNext();
                        if (value.substr(-1) === "{") {
                            spaceAfter = true;
                    ...
                    } else if (token.type === "paren.rparen" || token.type === "rparen") {
                        unindent = 1;
                        if (value.substr(0, 1) === "}") {
                    ...
                    if (token.type === "paren.lparen" || token.type === "lparen") {
                    ...
                    if (token.type === "paren.rparen" || token.type === "rparen") {
                        roundDepth -= (value.match(/\)/g) || []).length;
                        curlyDepth -= (value.match(/\}/g) || []).length;
